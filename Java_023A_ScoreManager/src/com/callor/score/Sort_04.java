...
public class Sort_04 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			...
			ScoreVO vo = new ScoreVO(String.format("%05d", i + 1), Integer.valueOf(subs[0]), Integer.valueOf(subs[1]),
					Integer.valueOf(subs[2]), Integer.valueOf(subs[3]), Integer.valueOf(subs[4]));
			vo.setTotal(sum);
			vo.setAvg(avg);
			scoreList.add(vo);
		}
