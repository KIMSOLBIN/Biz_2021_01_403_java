...
public class ScoreVO {
	...
	/*
	 * 1. 변수 이름 작명 2. 변수 타입 결정 3. 정보 은닉 설정(private)
	 */
	...
	/*
	 * 기본생성자 정의 ScoreVO score = new Score() 명령문에서 호출되는 생성자 메서드
	 */
	public ScoreVO() {
	}
	...
	/*
	 * private으로 선언되 인스턴스변수에 접근할 getter,setter method 생성
	 */
	...
	/*
	 * Object로 부터 상속받은 toString() method 재 정의
	 * 
	 * VO객체에 데이터를 저장한 후 잘 저장되었는지 확인하기 위한 Debuging 용 method 재 정의
	 *
	 */
	@Override
