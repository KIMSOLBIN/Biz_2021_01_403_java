...
import cam.callor.shop.service.CartService;
...
public class CartServiceImplV1 implements CartService {
	...
	private void printBody(CartVO cartVO) {
		...
		System.out.printf("%d\t", cartVO.getTotal());
	...
	public void printAllCart() {
		...
		for (int i = 0; i < nSize; i++) {
			/*
			 * cartList(i) 는 cartList에 저장되어있는 i 번째 요소 이 요소는 결국 CartVO 클래스로 만든 객체
			 */
			/*
