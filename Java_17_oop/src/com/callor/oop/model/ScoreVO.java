 ...
 * 보통 private으로 선언을 한다.
 * 
 * VO 클래스를 사용하여 선언된 VO 객체는 인스턴스 변수에 직접 접근할수 없다.
 * 
 * ScoreVO sVO = new ScoreVO();
 * sVO.strName = 홍길동" // 이런코드는 사용불사
...
public class ScoreVO {
	 ...
	 * 		변수는 private으로 setIntEng() method선언
	 * 
	 * intEng 변수의 값을 읽지도 못하는 상황이 발생한다.
	 * intEng 변수의 값을 저장한 후 읽을 수 있어야 되는데
	 * intEng 변수의 값을 읽기 위해서 getIntEng() 라는 메서드를 또 하나 선언해 둔다.
	 */
