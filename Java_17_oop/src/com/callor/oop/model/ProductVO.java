 ...
 * 
 * VO(Value Object) 클래스는 가장 중요한 부분이 인스턴스변수를 선언하는 부분
 * 
 * 상품관리를 위한 필요한 데이터들
 * Product :상품코드,상품명
 * Item :품목명,
