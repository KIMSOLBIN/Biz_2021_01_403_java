 ...
 * 		- 배열은 처음 생성한 개수를 변경하면, 저장되어 있던 데이터를 사용할수 없게 된다.
...
public class List_02 {
	...
	public static void main(String[] args) {
		...
		// strList 객체에는 String type의 데이터들만 추가할수 있다.
		// <String> :  Generic type
		...
		// strList은 Generic이 String으로 설정되어 있기 때문에
		// 문자열 외에는 add 할수 없다
		strList1.add("대한민국");
		// strList1.add(30);
		// strList1.add(30.0f);
		
		// intstList1은 Generic이 Integer로 설정되어 있기 때문에
		// 정수값 외에는 add 할수 없다.
		intList1.add(30);
		// intList1.add("30");
